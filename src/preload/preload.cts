...
const api: WriteLLMIpc = {
  ...
  createDocumentBlock: (payload) => ipcRenderer.invoke(ipcChannels.createDocumentBlock, payload),
  updateDocumentBlock: (blockId, payload) => ipcRenderer.invoke(ipcChannels.updateDocumentBlock, blockId, payload),
  deleteDocumentBlock: (blockId) => ipcRenderer.invoke(ipcChannels.deleteDocumentBlock, blockId),
