...
export const PROJECT_HISTORY_RELATIVE_PATH = '.writellm/history.git'
export const PROJECT_HISTORY_IGNORE_RELATIVE_PATH = '.writellm/.gitignore'
export const PROJECT_HISTORY_IGNORE_CONTENT = '*\n!.gitignore\n'
