const UNSAFE_MATH_COMMAND =
  /\\(?:input|include|includegraphics|write|openout|read|usepackage|documentclass|newcommand|renewcommand|providecommand|def|edef|gdef|xdef|catcode|special|immediate|csname|href|url|htmlclass|htmlid|htmlstyle|htmldata)\b/iu
