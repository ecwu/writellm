...
| 012 | [Icon and usability refresh](./012-icon-usability-refresh/spec.md)：统一推荐图标体系并提升所有已实现界面的易用性 | 001, 002, 003, 004, 011 | Draft | Missing | ADR gate pending plan | Missing | Not started |
