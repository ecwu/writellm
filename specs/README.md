...
| 006 | [Knowledge ingestion](./006-source-library-processing/spec.md)：批量导入 PDF，在后台解析、持久化内容块并建立索引 | 001, 002, 011 | Accepted | [Accepted v1.2](./006-source-library-processing/plan.md) | ADR-001 Accepted；ADR-003 Accepted；[ADR-005 v1.2](../docs/adr/005-source-ingestion-services-security.md) Accepted | [78/78](./006-source-library-processing/tasks.md) | Complete |
...
| 013 | [Workspace navigation redesign](./013-workspace-navigation-redesign/spec.md)：以 Sections、Knowledge Base 和全局 Settings 重组分栏工作区；Lyra UI revision accepted | 002, 003, 004, 005, 006, 011, 012 | Accepted | [Accepted](./013-workspace-navigation-redesign/plan.md) | ADR-003 Accepted；ADR-005 v1.2 Accepted；new ADR not required | [64/65](./013-workspace-navigation-redesign/tasks.md) | In progress — representative usability validation pending |
