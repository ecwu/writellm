...
| 012 | [Icon and usability refresh](./012-icon-usability-refresh/spec.md)：统一推荐图标体系并提升所有已实现界面的易用性 | 001, 002, 003, 004, 011 | Draft | [Draft](./012-icon-usability-refresh/plan.md) | ADR-003 Accepted；new ADR not required | Missing | Not started |
...
| 006 | [Knowledge ingestion](./006-source-library-processing/spec.md)：批量导入 PDF，在后台解析、持久化内容块并建立索引 | 001, 002, 005, 011 | Draft | [Draft](./006-source-library-processing/plan.md) | ADR-001 Accepted；ADR-003 Accepted | Missing | Not started |
