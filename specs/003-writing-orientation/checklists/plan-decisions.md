...
- [x] Maintainer accepts 003 spec and plan.
- [x] Maintainer accepts ADR-001 and the durable orientation storage contract.
- [x] Maintainer accepts the 003-defined extension of 002 project leave orchestration for dirty Save/Discard/Stay; no durable selection location is added.
