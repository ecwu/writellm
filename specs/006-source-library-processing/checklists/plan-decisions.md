...
- [x] CHK001 FR-001–FR-021 and SC-001–SC-009 map to the Phase 1 model, contracts, quickstart and explicit out-of-scope boundaries.
...
- [x] CHK010 ADR-005 covering MinerU and SiliconFlow credentials, transport and data egress is accepted.
...
- [x] CHK012 Feature spec, plan and contracts are maintainer Accepted and `specs/README.md` is updated in the same change.

CHK010 and CHK012 are satisfied; tasks and implementation may proceed in the accepted dependency order.
