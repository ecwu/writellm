...
| PIA-004 | [ADR-0005](adr/0005-select-pi-model-adapter-strategy.md), [ADR-0012](adr/0012-replace-interactive-generation-with-pi-agent-event-runtime.md), [ADR-0018](adr/0018-rebuild-llm-and-rag-on-pi-without-legacy-compatibility.md), [ADR-0020](adr/0020-limit-provider-secrets-to-the-privileged-backend.md) |
...
| PIA-007 | [ADR-0004](adr/0004-limit-mvp-to-an-allowlisted-local-tool-facade.md), [ADR-0011](adr/0011-bound-generation-retrieval-worker-lifecycles.md), [ADR-0012](adr/0012-replace-interactive-generation-with-pi-agent-event-runtime.md), [ADR-0019](adr/0019-isolate-pi-retrieval-and-backpressure-live-events.md), [ADR-0020](adr/0020-limit-provider-secrets-to-the-privileged-backend.md) |
